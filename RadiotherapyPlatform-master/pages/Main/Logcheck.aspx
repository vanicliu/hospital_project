<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Logcheck.aspx.cs" Inherits="pages_Main_Logcheck" %>
        ...
        <section id="addpatient-content" class="content table-responsive" style="background-color:#fff;width:1000px;">
                ...
                <div class="paper-title">
                    ...
                    <div class="paper-content">
                          <div id="buttonArea" class="single-row">
                           <div class="col-xs-5">
                                   <span class="form-text col-xs-3" style="padding-left:0px;">开始日期</span><input class="form-item" id="dates" name="dates" type="text" readonly="readonly" placeholder="选择日期" style="height:30px;""/>
                           </div>
                            <div class="col-xs-5">
                                 <span  class="form-text col-xs-3" style="padding-left:0px;">结束日期</span> <input class="form-item" id="datesend" name="datesend" type="text" readonly="readonly" placeholder="选择日期" style="height:30px;""/>
                            </div>
                            <div class="col-xs-2" style="padding-left:0px;">
                                <button id="sureDate" class="time-btn selected-btn">确定</button>
                            </div>   
                        </div>
                          <table id="loginfo" class="table table-bordered" style="text-align:center;">
                            <thead>
                               <th>
                                   操作人
                               </th>
...
<script src="../../js/Main/Logcheck.js"></script>
...
<script>
    ...
    $("#datesend").datepicker({ autoclose: true, format: 'yyyy-mm-dd' });
</script>
