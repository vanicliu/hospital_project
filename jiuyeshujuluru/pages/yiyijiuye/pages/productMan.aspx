        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="productMan.aspx" class="waves-effect active"> 产品系列管理 <i class="im-table2"></i></a>
                    </li>
                    <li><a href="riMan.aspx"> 科研投入管理 <i class="st-lab"></i></a>
                    </li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-primary toggle">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-wand"></i> 产品系列数据录入项管理</h4>
									<div  style="float:right;margin-top:5px">
                                          <input class="form-control" type="button" value="搜索" onclick="searchPro()" />      
                                    </div>
                                   <div class="col-lg-2" style="float:right;margin-top:5px;">
                                         <input id="searchPro" class="form-control" type="text" placeholder="请输入搜索内容" />                                        
                                   </div>
                                </div>
                                <div class="panel">
...
<script src="../JS/productMan.js"></script>
<script src="../JS/search.js"></script>
<script>
    $('#searchPro').on('keypress', function (event) {
        if (event.keyCode === 13) {
            searchPro();
        }
    });
