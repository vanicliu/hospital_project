<%@ Page Language="C#" AutoEventWireup="true" CodeFile="area.aspx.cs" Inherits="_Default" %>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-primary toggle">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-wand"></i> 分地区数据录入</h4>
                                </div>
                                <div id="oper" class="panel-body">
                                    <form id="wizard" class="form-horizontal form-wizard" role="form">
                                        ...
                                        <div class="wizard-actions">
                                            ...
                                            <button id="suba" class="btn pull-right" type="button">提交<!-- <i class="en-arrow-right5"></i> -->
                                            </button>
											 <button id="clean" type="button">清空数据<!-- <i class="en-arrow-right5"></i> -->
                                            </button>
                                        </div>
                                    </form>
                                </div>
...
<![endif]-->
       ...
       <script type="text/javascript" src="assets/server/jquery.js"></script> 
        <script type="text/javascript" src="assets/areaJS.js"></script> 
    </body>
</html>
