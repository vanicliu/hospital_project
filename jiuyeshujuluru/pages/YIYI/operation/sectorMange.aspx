<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sectorMange.aspx.cs" Inherits="sector" %>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li><a href="#" class="waves-effect active"><i class="im-images"></i> 分行业数据管理</a>
                    </li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-primary toggle">
                                ...
                                <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <select class="form-control select2" name="select2" id="select2">
                                                   ...
                                                   <label class="col-lg-2 control-label">选择酒类：</label>
                                            <div class="col-lg-10">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-wand"></i> 分行业数据</h4>
                                </div>
...
<![endif]-->
       ...
       <script type="text/javascript" src="assets/server/jquery.js"></script> 
        <script type="text/javascript" src="assets/sectorar.js"></script> 
    </body>
</html>
