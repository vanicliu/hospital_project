<%@ Page Language="C#" AutoEventWireup="true" CodeFile="historyManage.aspx.cs" Inherits="pages_historyManage" %>
...
<body>
   ...
   <div id="content">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="panel panel-primary toggle">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-wand"></i> 企业历史数据录入项管理</h4>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="table-1" class="table table-striped" style="font-size:12px; " > <!-- Replace "table-1" with any of the design numbers -->
                                      <thead>
                                        <th style="text-align:center;width:80px;">企业名称</th>
                                        <th style="text-align:center;width:80px;">建企时间 </th>
                                         <th style="text-align:center;width:80px;">原名</th>
                                         <th style="text-align:center;width:80px;">现名</th>
                                         <th style="text-align:center;width:80px;">时间</th>
                                           <th style="text-align:center;width:80px;">原名2</th>
                                         <th style="text-align:center;width:80px;">现名2</th>
                                         <th style="text-align:center;width:80px;">时间2</th>
                                           <th style="text-align:center;width:80px;">原名3</th>
                                         <th style="text-align:center;width:80px;">现名3</th>
                                         <th style="text-align:center;width:80px;">时间3</th>
                                         <th style="text-align:center;width:80px;">遗迹传承</th>
                                          <th style="text-align:center;width:80px;">产品类型</th>
                                         <th style="text-align:center;width:80px;">录入时间</th>
                                         <th style="text-align:center;width:50px;">操作</th>
                                          <th style="text-align:center;width:90px;">操作</th>
                                          </thead>
                                           <tbody id="historytr" style="text-align:center;">
                                            </tbody>
                                        </table>
                                </div>
                            </div>
       ...
       <script src="../JS/historyManage.js"></script>
