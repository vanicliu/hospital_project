    ...
    private string getfixrecordinfo(HttpContext context)
    {
        ...
        while (reader.Read())
        {
            ...
            backText.Append("{\"ID\":\"" + reader["ID"].ToString() + "\",\"group\":\"" + reader["Group_ID"].ToString() + "\",\"IDcardNumber\":\"" + reader["IdentificationNumber"] + "\",\"Hospital\":\"" + reader["Hospital"] +
                 "\",\"Sub\":\"" + reader["SubCenterPrincipal_ID"].ToString() + "\",\"RecordNumber\":\"" + reader["RecordNumber"].ToString() + "\",\"newCardId\":\"" + reader["newCardId"].ToString() + "\",\"Picture\":\"" + reader["Picture"].ToString() + "\",\"Name\":\"" + reader["Name"].ToString() +
