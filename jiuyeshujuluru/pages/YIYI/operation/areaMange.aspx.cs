...
public partial class _Default : System.Web.UI.Page
{
    ...
    public static string AjaxMethod()
    {
        ...
        _sqlConnect.Open();
        _sqlCommand.CommandText = "select distinct company from `sub-area_data`";
    ...
    [System.Web.Services.WebMethod()]
    public static string AjaxMethod1(String company, String year, String area)
    {
        String str1 = "{\"olist\":[";
        ...
        _sqlCommand1.Parameters.AddWithValue("@area", area);
        _sqlCommand1.CommandText = "SELECT * FROM `sub-area_data` WHERE company=@company AND yearl=@year AND area=@area";
    ...
    public static string AjaxMethod2(String sltCompany)
    {
        ...
        _sqlCommand1.CommandText = "SELECT distinct yearl FROM `sub-area_data` WHERE company=@sltCompany";
        if (_sqlCommand1.Connection == null)
        {
    ...
    [System.Web.Services.WebMethod()]
    public static string AjaxMethod3(List<string> olist, string yeardom, string areadom, string companydom)
    {
        string sb = "(";
        ...
        _sqlCommand.Parameters.AddWithValue("@Areanow", olist[1]);
        ...
        _sqlCommand.Parameters.AddWithValue("@Areadom", areadom);
        _sqlCommand.CommandText = "SELECT * FROM `sub-area_data` WHERE company=@Companynow AND yearl=@Yearnow AND area=@Areanow";
        if (_sqlCommand.Connection == null)
        {
        ...
        if (olist[0] != yeardom || olist[1] != areadom ||olist[2] !=companydom)
        {
            MySqlDataReader reader = _sqlCommand.ExecuteReader();
        ...
        try
        {
            _sqlCommand.CommandText = "DELETE FROM `sub-area_data` WHERE company=@Companydom AND yearl=@Yeardom AND area=@Areadom";
    ...
    [System.Web.Services.WebMethod()]
    public static string AjaxMethod4(String company, String year, String area )
    {
        MySqlConnection _sqlConnect1;//Mysql连接对象
        ...
        _sqlCommand1.Parameters.AddWithValue("@year", year);
        _sqlCommand1.Parameters.AddWithValue("@area", area);
        _sqlCommand1.CommandText = "DELETE FROM `sub-area_data` WHERE company=@company AND yearl=@year AND area=@area";
        if (_sqlCommand1.Connection == null)
        {
    ...
    public static string AjaxMethod5(String sltCompany,String sltYear)
    {
        ...
        _sqlCommand1.CommandText = "SELECT area FROM `sub-area_data` WHERE company=@sltCompany AND yearl=@sltYear";
        if (_sqlCommand1.Connection == null)
        {
