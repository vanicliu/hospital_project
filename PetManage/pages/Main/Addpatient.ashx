...
public class Addpatient : IHttpHandler {
    ...
    private string RecordPatientInformation(HttpContext context)
    {
        ...
        //}
            ...
            //插入数据
            string strSqlCommand = "INSERT INTO patient(newCardId,IdentificationNumber,Hospital,RecordNumber,Picture,Name,Gender,Age,Birthday,Nation,Address,Contact1,Contact2,Height,RegisterDoctor,Weight,Register_User_ID,RegisterTime,SubCenterPrincipal_ID,Radiotherapy_ID,Principal_User_ID,Hospital_ID,Ishospital,Nameping) VALUES("
             + "@newCardId,@IdentificationNumber,@Hospital,@RecordNumber,@Picture,@Name,@Gender,@Age,@Birthday,@Nation,@Address,@Contact1,@Contact2,@Height,@doctorid,@Weight,@Register_User_ID,@RegisterTime,@SubCenterPrincipal_ID,@Radiotherapy_ID,@Principal_User_ID,@hospitalnumber,@Ishospital,@Nameping)";
            
           //各参数赋予实际值
            sqlOperation.AddParameterWithValue("@newCardId", context.Request.Form["newCardId2"]);
