<%@ Page Language="C#" AutoEventWireup="true" CodeFile="operationMange.aspx.cs" Inherits="product" %>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-inner">
                ...
                <ul id="sideNav" class="nav nav-pills nav-stacked">
                    ...
                    <li>
                        <a href="#" class="waves-effect active"> 经营状况管理 <i class="im-paragraph-justify"></i></a>

                    </li>
                    <li><a href="sectorMange.aspx"><i class="im-images"></i> 分行业数据管理</a>
                    </li>
                    <li><a href="areaMange.aspx"><i class="st-diamond"></i> 分地区数据管理 </a>
                    </li>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel panel-primary toggle">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="im-wand"></i> 经营状况数据</h4>
                                </div>
                                    ...
                                    <form id="wizard" class="form-horizontal form-wizard" role="form">
                                        ...
                                        <div class="step" id="first">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <input onkeyup="value=value.replace(/[^\d\.]/g,'')" list="itemlist" class="form-control" name="firstname" type="text"/>
                                        ...
                                        <div class="step submit_step" id="Div31">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">吨酒销售价格（营业收入除以产品产量）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div32">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">吨酒销售利润（利润总额除以产品产量）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div33">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">吨酒销售费用（销售费用除以产品产量）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div34">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">吨酒管理费用（管理费用除以产品产量）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div35">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">资产利润率（利润总额除以总资产）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div36">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">人均利润率（利润总额除以职工总数）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div37">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">人均销售收入（营业收入除以职工总数）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div38">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
                                                <label class="col-lg-3 control-label">人均收入（职工薪酬除以职工总数）</label>
                                                <div class="col-lg-9">
                                                    <input readonly="readonly" class="form-control" name="password" type="text"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="step submit_step" id="Div39">
                                            <span data-icon="ec-unlocked" data-text="Account information"></span>
                                            <!-- End .control-group  -->
                                            <div class="form-group">
...
<![endif]-->
       ...
       <script type="text/javascript" src="assets/server/jquery.js"></script> 
        <script type="text/javascript" src="assets/operar.js"></script> 
    </body>
</html>
