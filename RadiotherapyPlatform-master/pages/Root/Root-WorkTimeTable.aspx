<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Root-WorkTimeTable.aspx.cs" Inherits="pages_Root_Root_WorkTimeTable" %>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 916px;">
            <section class="content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h1 class="page-header">预约日期配置</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-md-offset-3">
                        <input type="text" id="chooseDate" class="form-control" />
                    </div>
                    <div class="col-md-3">
                        <button id="sureChoose" class="btn btn-block btn-primary">新增日期</button>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="panel panel-default mintablewidth">
                        <div class="panel-heading mintablewidth">
                            ...
                            <span class="panel-title">不工作日期</span>
                        </div>
                        <div id="tableArea" class="panel-body mintablewidth">
                            <div class="row">
                                <div class="col-md-2">
                                    <select id="chooseShowMonth" class="form-control">
                                ...
                                <div class="col-md-1">
                                    <button id="sureChooseMonth" class="btn btn-block btn-primary">查看</button>
                                </div>
                            </div>
...
<script src="../../js/Root/createTable.js"></script>
<script src="../../js/Root/WorkTimeTable.js"></script>
    <script type="text/javascript">
        ...
        //});
        $("#chooseDate").datepicker({ autoclose: true });
</script>
</body>
</html>
