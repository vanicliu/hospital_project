...
public class TreatmentRecord : IHttpHandler {
    ...
    private string treatrecord(HttpContext context)
    {
        ...
        int fillnum=Convert.ToInt32(context.Request["fillnumber"]);
        ...
        sqlOperation.AddParameterWithValue("@treattimes", finishedtimes + fillnum + 1);
        sqlOperation.AddParameterWithValue("@rest", totalnumber-fillnum-finishedtimes - 1);
