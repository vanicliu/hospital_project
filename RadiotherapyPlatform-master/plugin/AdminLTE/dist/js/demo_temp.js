...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      + "固定布局"
      + "</label>"
      + "<p style='font-size: 12px'>激活固定布局固定布局和盒装布局不能一起使用</p>"
      + "</div>"
        //Boxed layout
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      ...
      + "盒装布局"
      + "</label>"
      + "<p style='font-size: 12px'>激活盒装布局</p>"
      + "</div>"
        //Sidebar Toggle
      + "<div class='form-group'>"
      + "<label class='control-sidebar-subheading'>"
      ...
      + "侧边栏开关"
      + "</label>"
      + "<p style='font-size: 12px'>切换左侧边栏的状态(打开或折叠)</p>"
      + "</div>"
      ...
      + "侧边栏展开悬停"
      + "</label>"
      + "<p style='font-size: 12px'>让侧边栏最小化展开悬停</p>"
      + "</div>"
      ...
      + "右侧边栏滑动开关"
      + "</label>"
      + "<p style='font-size: 12px'>在滑动和推动效果之间切换</p>"
      + "</div>"
      ...
      + "右侧边栏皮肤开关"
      + "</label>"
      + "<p style='font-size: 12px'>右侧边栏在暗色和浅色皮肤之间切换</p>"
      + "</div>"
  );
  ...
  var skin_black =
      $("<li />", {style: "float:left; width: 33.33333%; padding: 5px;"})
          ...
          + "</a>"
          + "<p class='text-center no-margin' style='font-size: 12px'>黑色</p>");
